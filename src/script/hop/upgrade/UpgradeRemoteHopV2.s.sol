...
// forge script src/script/hop/upgrade/UpgradeRemoteHopV2.s.sol --rpc-url https://evm-rpc.sei-apis.com --ffi --gcp --sender 0x54f9b12743a7deec0ea48721683cbebedc6e17bc --broadcast --verify --verifier-url https://seitrace.com/pacific-1/api --verifier custom --verifier-api-key $ETHERSCAN_API_KEY
...
// forge script src/script/hop/upgrade/UpgradeRemoteHopV2.s.sol --rpc-url https://xlayerrpc.okx.com --ffi --legacy --broadcast --verify --verifier-url https://www.oklink.com/api/v5/explorer/contract/verify-source-code-plugin/XLAYER --verifier oklink --verifier-api-key $OKLINK_API_KEY
// abstract
...
contract UpgradeRemoteHopV2 is UpgradeHopV2 {
    ...
    function deployImplementation() internal virtual override {
        ...
        require(newImplementation == 0x0000000f9a66622C8885E1071B78E37b2b3ecCCd, "Unexpected implementation address");
