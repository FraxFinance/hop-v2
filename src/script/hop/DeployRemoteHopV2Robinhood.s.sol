...
// Step 1 (default profile, mints the canonical V201 implementation — see DeployRemoteHopV201.s.sol):
...
// Step 2 — Dry run: FOUNDRY_PROFILE=deploy forge script src/script/hop/DeployRemoteHopV2Robinhood.s.sol --rpc-url https://rpc.mainnet.chain.robinhood.com --gcp --sender 0x54f9b12743a7deec0ea48721683cbebedc6e17bc
// Step 2 — Broadcast: FOUNDRY_PROFILE=deploy forge script src/script/hop/DeployRemoteHopV2Robinhood.s.sol --rpc-url https://rpc.mainnet.chain.robinhood.com --gcp --sender 0x54f9b12743a7deec0ea48721683cbebedc6e17bc --broadcast
contract DeployRemoteHopV2Robinhood is DeployRemoteHopV2 {
    address constant REMOTE_ADMIN = 0xbfCb6F2f811a0DA4D54386458bF888B769EbFc5F;
    ...
    constructor() {
        ...
        // No FPI on Robinhood (retired before this chain onboarded)
    }
