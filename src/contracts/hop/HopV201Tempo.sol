...
///         (DEFAULT_ADMIN_ROLE-gated `recoverERC20`, no unbounded `recover()`), with two
///         deliberate divergences for Tempo:
///
///         1. `recoverETH` is intentionally not implemented. Tempo settles all fees in TIP20 /
...
contract HopV201Tempo is AccessControlEnumerableUpgradeable, IHopV201 {
    ...
    /// @dev not implemented
    function recoverETH(uint256) external pure override {
